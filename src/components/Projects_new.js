...
const Projects = () => {
    ...
    }, [dragStart, currentIndex, maxIndex, handleNext, handlePrev])
                ...
                <div className="relative">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <motion.button
                            ...
                            className={`p-3 rounded-full glass transition-all duration-300 ${currentIndex === 0 || isAnimating
                        ...
                        <div className="flex space-x-2">
                            {Array.from({ length: maxIndex + 1 }, (_, i) => (
                                <motion.div
                                    key={i}
                                    className={`h-2 rounded-full transition-all duration-300 ${i === currentIndex ? 'bg-purple-500 w-8' : 'bg-gray-600 w-2'
                                        }`}
                        ...
                        <motion.button
                            ...
                            className={`p-3 rounded-full glass transition-all duration-300 ${currentIndex >= maxIndex || isAnimating
                                    ? 'opacity-50 cursor-not-allowed'
                                    : 'hover:bg-purple-500/20 hover:scale-110'
                                }`}
                        >
                    ...
                    >
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                animate="visible"
                                exit="exit"
                                className={`grid gap-6 h-full ${itemsPerView === 1 ? 'grid-cols-1' :
